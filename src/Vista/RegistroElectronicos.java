...
public class RegistroElectronicos extends javax.swing.JFrame {

    int datoSeleccionado = -1;

    public RegistroElectronicos() {
        initComponents();
...
//}
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), "Registro De Electronicos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Yu Gothic UI Semibold", 1, 36))); // NOI18N
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        if (datoSeleccionado >= 0) {
            RegistroElectronicos.jTextFieldIDProducto.setText(String.valueOf(jTableProducto.getValueAt(datoSeleccionado, 0)));
            RegistroElectronicos.jTextFieldNombre.setText(String.valueOf(jTableProducto.getValueAt(datoSeleccionado, 1)));
            RegistroElectronicos.jTextFielDescripcion.setText(String.valueOf(jTableProducto.getValueAt(datoSeleccionado, 2)));
            RegistroElectronicos.jTextFieldCantidad.setText(String.valueOf(jTableProducto.getValueAt(datoSeleccionado, 3)));
    ...
    private void jButtonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonActualizarActionPerformed
        try {
            if (jTextFieldIDProducto.getText().isEmpty()
                ...
                editarProducto();
                limpiar();
                RegistroElectronicos.jButtonGuardar.setVisible(true);
                RegistroElectronicos.botonmostrar.doClick();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroElectronicos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroElectronicos().setVisible(true);
            }
        });
    }
