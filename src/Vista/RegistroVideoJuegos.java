 ...
 * @author Oneyker21
 */
public class RegistroVideoJuegos extends javax.swing.JFrame {

    public RegistroVideoJuegos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), "Registro  De VideoJuegos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Yu Gothic UI Semibold", 1, 36))); // NOI18N
        ...
        jPanel1.add(Cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 30, 30, 30));
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroVideoJuegos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroVideoJuegos().setVisible(true);
            }
        });
    }
